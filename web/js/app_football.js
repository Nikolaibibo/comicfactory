(async (window, d, undefined) => {
    ...
    async function loadWorkflow() {
        const response = await fetch('/comic/js/faceswap.json');
    ...
    async function checkPrompt () {
        ...
        radioButtons.forEach(radioButton => {
            if (radioButton.checked) {
                ...
                switch (radioButton.value) {
                    case '1':
                        selectedPose = "pose1.jpg";
                        break;
                    case '2':
                        selectedPose = "pose2.jpg";
                        break;
                    case '3':
                        selectedPose = "pose3.jpg";
                        break;
                    default:
                        break;
                }
        ...
        // Pose
        workflow["1"]["inputs"]["image"] = selectedPose;
        
        // user upload
        workflow["2"]["inputs"]["image"] = uploadImageName;
