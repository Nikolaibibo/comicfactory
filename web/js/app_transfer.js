(async (window, d, undefined) => {
    ...
    async function checkPrompt () {
        ...
        let currentPrompt = "A soccer player, cheering after a game, in a stadium, scenic";
        let negPrompt = "deformed, glitch, b&w, black and white, noisy, ugly, cropped, nsfw, sexy, naked";
        let poseImage = "pose1.jpg"
        ...
        radioButtons.forEach(radioButton => {
            if (radioButton.checked) {
                switch (radioButton.value) {
                    case '1':
                        currentPrompt = "A soccer player sliding on his knees, in a stadium, scenic";
                        poseImage = "pose1.jpg"
                        //negPrompt = "deformed, glitch, noisy, ugly, cropped";
                        console.log("! it is")
                        break;
                        case '2':
                            currentPrompt = "A soccer player, cheering after a game, in a stadium, scenic";
                            poseImage = "pose2.jpg"
                            //negPrompt = "deformed, glitch, noisy, ugly, cropped";
                            console.log("2 it is")
                            break;
                            case '3':
                                currentPrompt = "A soccer player in motion, energetically during a game, stadium, scenic";
                                poseImage = "pose3.jpg"
                            //negPrompt = "deformed, glitch, noisy, ugly, cropped";
                            console.log("3 it is")
                        break;
        ...
        workflow["74"]["inputs"]["image"] = poseImage;
